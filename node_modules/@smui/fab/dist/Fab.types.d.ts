...
export declare class FabComponentDev<C extends SvelteComponentDev = ButtonElementComponentDev> extends Component {
     ...
     * ### DO NOT USE!
     */
    $$prop_def: Omit<Partial<svelte.JSX.HTMLAttributes<ReturnType<C['getElement']>>>, 'use' | 'class' | 'style' | 'ripple' | 'color' | 'mini' | 'exited' | 'extended' | 'touch' | 'href' | 'component'> & Component['$$prop_def'];
}
