...
export declare class AutocompleteComponentDev extends Component {
     ...
     * ### DO NOT USE!
     */
    $$prop_def: Omit<Partial<svelte.JSX.HTMLAttributes<HTMLSpanElement>>, 'use' | 'class' | 'options' | 'value' | 'getOptionDisabled' | 'getOptionLabel' | 'text' | 'label' | 'disabled' | 'toggle' | 'combobox' | 'clearOnBlur' | 'selectOnExactMatch' | 'showMenuWithNoInput' | 'noMatchesActionDisabled' | 'search'> & {
